...
public class Postagem {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY) //transferindo a reasponabilidade de regar a chave primaria // chave primária 
	private Long id;
	
	@NotBlank(message = "O atrinuto título é Obrigatório")
