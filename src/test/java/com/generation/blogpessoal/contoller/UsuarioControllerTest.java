package com.generation.blogpessoal.contoller;
...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) // definindo a ordenação dos meus testes
public class UsuarioControllerTest {

	@Autowired
	private TestRestTemplate testRestTemplate;// gerar uma requisição
	...
	public void deveCriarUmUsuario() {
		...
		assertEquals(HttpStatus.CREATED, resposta.getStatusCode());// é verdade que a resposta é created?
	...
	@Test
	@Order(5)
	@DisplayName("Consulte Usuário por Id")
	public void deveMostrarUsuariosId() {
